...
Partial Class AttendanceReport
    ...
    Public Shared Function GetData(sdate As String, edate As String, Bunit As String) As DGrid
        ...
        Try
            ...
            If System.Web.HttpContext.Current.Session("USERROLE") = "HRSPOC" Then
                da.SelectCommand.CommandText = "select qryfield[cmd] from mmm_mst_report with(nolock) where reportid=961"
            Else
                da.SelectCommand.CommandText = "select qryfieldrole[cmd] from mmm_mst_report with(nolock) where reportid=961"
            End If
            da.Fill(ds, "qry")
    ...
    Public Shared Function GetExport(sdate As String, edate As String, Bunit As String) As String
        ...
        Try
            ...
            da.SelectCommand.CommandTimeout = 900
            da.Fill(dt)
            Dim fname As String = "AttendanceReport.CSV"
