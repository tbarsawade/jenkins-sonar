...
Partial Class mobile_MasterEdit
        ...
        If Not Page.IsPostBack Then
            If Request.QueryString.HasKeys() Then
                If Request.QueryString("SC") <> Nothing Then
                    Dim Pid As Integer = Val(Request.QueryString("DOCID"))
                    BindControls(Pid)
                End If
            End If
        End If
    End Sub
    Protected Sub BindControls(pid As Integer)
    ...
    Protected Sub ValidateData(ByVal actionType As String)
        ...
        Else
            ...
            FinalQry = ob.ValidateAndGenrateQueryForControls("UPDATE", "UPDATE MMM_MST_MASTER SET updateddate=getdate(),", "", ds.Tables("fields"), pnlFields, Val(Request.QueryString("DOCID")))
        End If
        ...
        Else
            If actionType <> "ADD" Then
                FinalQry = FinalQry & " WHERE tID=" & Val(Request.QueryString("DOCID"))
            Else
            ...
            If actionType <> "ADD" Then
                fileid = Request.QueryString("DOCID")
