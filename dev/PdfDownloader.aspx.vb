...
Partial Class PdfDownloader
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        TemplateCallingDownload(Trim(txtDocid.Text), 136, "QC Document", "CREATED")
    End Sub
    ...
    Public Sub TemplateCallingDownload(ByVal tid As Integer, ByVal eid As Integer, ByVal en As String, ByVal SUBEVENT As String, Optional ByVal upCommingFrom As String = "", Optional ByVal TicketCC As String = "")
        ...
        Try
            ...
            da.SelectCommand.CommandText = "Select T.TID,T.msgBody,T.subject,T.MAILTO,T.CC,T.BCC,T.EventName,T.qry,T.specialfieldflag,isnull(T.condition,'') as condition from MMM_MST_TEMPLATE T  WHERE T.tid=2566"
            da.Fill(DS, "TEMP")
    ...
    Private Sub SendMailPdf(ByVal Mto As String, ByVal cc As String, ByVal bcc As String, ByVal MSubject As String, ByVal MBody As String, ByVal backuppath As String)
        ...
        Try
            ...
            Dim att As System.Net.Mail.Attachment = Nothing
