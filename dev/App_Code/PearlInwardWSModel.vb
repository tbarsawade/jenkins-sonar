...
Public Class PearlInwardWSModel
    ...
    Public Class TTSLPurchaseOrder
        ...
        Public Property PurchaseOrganization As String
        Public Property Department As String
        Public Property PaymentTerms As String
        ...
        Public Property TotalPOAmount As String
        Public Property PORemarks As String
        'Public Property Disputeifany As String
        'Public Property DisputeResolutionRemarks As String
