...
Partial Class _GimmePWD
    ...
    Protected Sub btnGive_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGive.Click
        txtResult.Text = DecryptTripleDES(txtPass.Text, txtKey.Text)
    End Sub


    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        Me.TextBox3.Text = EncryptTripleDES(TextBox1.Text, TextBox2.Text)
    End Sub
End Class
