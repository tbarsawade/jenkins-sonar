...
Partial Class DeviceLocationold
    ...
    Protected Sub Button1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim r As String = "select lattitude,longitude,ctime,speed,recordTime from MMM_MST_GPSDATA where tid in (select max(tid) from MMM_MST_GPSDATA where IMIENO='" & txtIMIENo.Text & "'  and   cTime >= '" + Date1.Text + " " + TextBox1.Text + "' AND ctime <= '" + Date2.Text + " " + TextBox2.Text + "' group by lattitude,longitude) order by ctime "
        ...
        oda.SelectCommand.CommandText = "select sum(DevDist) as DevDist,max(speed) speed from MMM_MST_GPSDATA where devdist <> 0  and   IMIENO='" & txtIMIENo.Text & "'  and   cTime >= '" + Date1.Text + " " + TextBox1.Text + "' AND ctime <= '" + Date2.Text + " " + TextBox2.Text + "' "
