...
Partial Class ReportOnMap
    Inherits System.Web.UI.Page
    Shared dt As DataTable
    Shared mval As String = ""
            ...
            If dt.Rows.Count > 0 Then
                For i As Integer = 0 To dt.Rows.Count - 1
                    ...
                    If dt.Rows(i).Item("GeoPoint").ToString.Trim <> "" And dt.Rows(i).Item("GeoPoint").ToString.Contains("Error") = False Then
                        geopoint = geopoint & "['Policy No: " & dt.Rows(i).Item("Policy Number").ToString & "<br> Product Name: " & dt.Rows(i).Item("Product Name").ToString & "<br>Advisor Code: " & dt.Rows(i).Item("Advisor Code").ToString & "'," & dt.Rows(i).Item("GeoPoint").ToString & ",'images/human.png'],"
                    End If
                Next
                'geopoint =  geopoint 
                If geopoint <> "" Then
