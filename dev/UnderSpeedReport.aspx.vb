...
Partial Class UnderSpeedReport
    ...
    End Sub
    <WebMethod>
    Public Shared Function GetJSON(d1 As String, d2 As String) As pichartColUnderSpeed
        Dim ret As New pichartColUnderSpeed()
        Dim ds As New DataSet()
        Dim Query As String = ""
        ...
        Try
            ...
            '    'Next
            '    Dim obj As pichartUnderSpeed
            '    Dim o1 As New List(Of pichartUnderSpeed)()
            '    Dim o2 As New List(Of pichartUnderSpeed)()
            '    Dim o3 As New List(Of pichartUnderSpeed)()
            '    For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
            '        obj = New pichartUnderSpeed()
...
End Class
Public Class pichartUnderSpeed
    Public category As String
    Public value As String
    'Public color As String
End Class
Public Class pichartColUnderSpeed
