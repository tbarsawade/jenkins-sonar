...
Partial Class ReportMasterK
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Else
            ...
            Try
                ...
                ob.CreateControlsOnReport_Kendu(ds.Tables("data"), pnlFields, scrname)
    ...
    Protected Shared Function showViewOffReport1(data As Dictionary(Of String, Object)) As DGrid
        ...
        Try
            ...
            End If
            da.SelectCommand.CommandText = "select count(*) from MMM_PreRole_dataFilter where eid= " & HttpContext.Current.Session("EID") & " and rolename='" & HttpContext.Current.Session("USERROLE") & "'"
            Dim apre As Integer = da.SelectCommand.ExecuteScalar()
            If apre <> "0" Then
                ReportQuery = Replace(ReportQuery, "@uid", HttpContext.Current.Session("UID"))
                ReportQuery = Replace(ReportQuery, "@role", "'" & HttpContext.Current.Session("USERROLE") & "'")
