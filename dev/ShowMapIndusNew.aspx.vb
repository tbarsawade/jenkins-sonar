...
Partial Class ShowMapIndusNew
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If type.ToString().ToUpper <> "MANUAL" Then
            ...
            TotalDistance.Text = ds.Tables("speedtable").Rows(0).Item("Dist").ToString
    ...
    Private Function GetAngle(lat1 As Double, long1 As Double, lat2 As Double, long2 As Double) As Double
        ...
        lat1 = ShowMapIndusNew.DegToRad(lat1)
        long1 = ShowMapIndusNew.DegToRad(long1)
        lat2 = ShowMapIndusNew.DegToRad(lat2)
        long2 = ShowMapIndusNew.DegToRad(long2)
        Dim ra = Math.PI / 180
        Dim deg = 180 / Math.PI
        Dim x = lat2 - lat1
        Dim y = long2 - long1
