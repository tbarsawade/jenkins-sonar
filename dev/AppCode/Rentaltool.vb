...
Public Class Rentaltool
                                    ...
                                    If ds.Tables("AutoInvDocData").Rows.Count <> 0 Then
                                        ...
                                        For j As Integer = 0 To ds.Tables("AutoInvDocData").Rows.Count - 1
                                            ...
                                            Try
                                                ...
                                                If ds.Tables("AutoInvDocData").Rows(j).Item("leasetype") = "1491591" Then 'Rental
                                                    ...
                                                    For f As Integer = 0 To names.Count - 1
                                                        If names(f).ToUpper() = ("Rental Invoice").ToUpper() Then
                                                            ...
                                                            If ds.Tables("SourceDocData").Rows.Count > 0 Then
                                                                    ...
                                                                    If CDate(LeaseComDate) = Date.Now Then
                                                                        If LRenttype = 1554651 Or LRenttype = 1554653 Then 'Fixed or 'Fixed and Revenue Sharing 
                                                                            ...
                                                                            If res <> 0 Then
                                                                                ...
                                                                                End Try
                                                                                tran.Commit()
                                                                                AutoRunLog("Run_FTP_Inward_Integration", "AutoInvoice", "Calling AutoInvoice Function ALL Now 1", 181)
                                                                ...
                                                                ElseIf ds.Tables("RDOCIDData").Rows.Count > 0 And Convert.ToString(names(f)) = "Rental Invoice" Then
                                                                    ...
                                                                    If ((CDate(LEdt1) >= CDate(InvGenDt)) And (CDate(NInvdtdt) > CDate(LEdt1))) Then
                                                                            ...
                                                                            If LRenttype = 1554651 Or LRenttype = 1554653 Then 'Fixed or 'Fixed and Revenue Sharing 
                                                                                ...
                                                                                If res <> 0 Then
                                                                                    ...
                                                                                    If rowECD.Length > 0 Then
                                                                                        ...
                                                                                        Next
                                                                                    End If
                                                                                    Dim rowMGAmt As DataRow() = ds.Tables("fields").Select("DisplayName='MG Amount'  and Datatype='Numeric' and Documenttype='rental Invoice'")
                                                                                    If rowMGAmt.Length > 0 Then
                                                                                        For Each CField As DataRow In rowMGAmt
                                                                                            MGAmtDT = BAMnt
                                                                                            Dim upquery As String = "update " & CField.Item("DBTableName").ToString & "  set  " & CField.Item("FieldMapping").ToString & "='" & MGAmtDT & "'  where eid=" & EID & " and Documenttype='" & names(f) & "' and tid =" & res & ""
                                                                                    ...
                                                                                    End Try
                                                                                    tran.Commit()
                                                                                    AutoRunLog("Run_FTP_Inward_Integration", "AutoInvoice_rentalinv", "Calling AutoInvoice Function ALL Now 1", 181)
                                                                                    ob1.TemplateCalling(res, EID, Convert.ToString(names(f)), "CREATED")
                                                                                    da.SelectCommand.CommandType = CommandType.Text
                                                                                    da.SelectCommand.Parameters.Clear()
                                                                                    da.SelectCommand.CommandText = "select isworkflow from mmm_mst_doc where TID=" & res & " and eid='" & EID & "'"
                                                                    ...
                                                                    ElseIf ((CDate(ESCGenDt) > CDate(InvGenDt)) And (CDate(NInvdtdt) > CDate(ESCGenDt))) Then
                                                                        ...
                                                                        If names(f).ToUpper() = ("Rental Invoice").ToUpper() Then
                                                                            ...
                                                                            If LRenttype = 1554651 Or LRenttype = 1554653 Then 'Fixed or 'Fixed and Revenue Sharing 
                                                                                ...
                                                                                ElseIf Convert.ToString(ds.Tables("AutoInvSettingData").Rows(i).Item("IsDoc_Master")) = "MMM_MST_DOC" Then
                                                                                    ...
                                                                                    insStr = "insert into " & Convert.ToString(ds.Tables("AutoInvSettingData").Rows(i).Item("IsDoc_Master")) & " (documenttype,EID,ISAUTH,ADATE,CreatedOn,LASTUPDATE,OUID," & strTFlds & ",RDOCID) values ('" & Convert.ToString(names(f)) & "'," & EID & ",1,getdate(),gatdate(),getdate(),'30200'," & value & ",'" & ds.Tables("SourceDocData").Rows(0).Item("RDOCID") & "' );"
                                                                                End If
                                                                                da.SelectCommand.CommandText = insStr.ToString() & ";Select @@identity"
                                                                                da.SelectCommand.CommandType = CommandType.Text
                                                                                da.SelectCommand.Transaction = tran
                                                        ...
                                                        End If
                                                    Next
                                                ElseIf ds.Tables("AutoInvDocData").Rows(j).Item("leasetype") = "1491592" Then 'Security Deposit
                                                    Dim names As List(Of String) = (From row In ds.Tables("AutoInvFieldData").AsEnumerable()
                                                                                    Select row.Field(Of String)("TDocType") Distinct).ToList()
                                                    For f As Integer = 0 To names.Count - 1
                                                                ...
                                                                If ds.Tables("RDOCIDData").Rows.Count = 0 Then
                                                                    If CDate(LeaseComDate) = Date.Now Then
                                                                        ...
                                                                        If res <> 0 Then
                                                                            ...
                                                                            End Try
                                                                            tran.Commit()
                                                                            AutoRunLog("Run_FTP_Inward_Integration", "AutoInvoice_Securityinv", "Calling AutoInvoice Function ALL Now 1", 181)
                                                                            ob1.TemplateCalling(res, EID, Convert.ToString(names(f)), "CREATED")
                                                                            da.SelectCommand.CommandType = CommandType.Text
                                                                            da.SelectCommand.Parameters.Clear()
                                                                            da.SelectCommand.CommandText = "select isworkflow from mmm_mst_doc where TID=" & res & " and eid='" & EID & "'"
                                                                ...
                                                                ElseIf ds.Tables("RDOCIDData").Rows.Count > 0 And (Convert.ToString(names(f)) = "Security Deposit") Then
                                                                    ...
                                                                    If Convert.ToString(names(f)) = "Security Deposit" Then
                                                                        ...
                                                                        If rowRCD.Length > 0 Then
                                                                            ...
                                                                            Next
                                                                        End If
                                                                        da.SelectCommand.CommandText = "Select top 1 " & Fieldmap & "  as InvCreationDt from mmm_mst_doc with (nolock) where fld19='" & LDocNo & "' and eid=" & EID & "  and Documenttype='" & Convert.ToString(names(f)) & "' order by tid desc "
                                                                        da.SelectCommand.Transaction = tran
                                                                    End If
                                                        ...
                                                        End If
                                                    Next
                                                ElseIf ds.Tables("AutoInvDocData").Rows(j).Item("leasetype") = "1554309" Then 'Rental And SD
                                                    ...
                                                    For f As Integer = 0 To names.Count - 1
                                                        ...
                                                        End If
                                                    Next
                                                ElseIf ds.Tables("AutoInvDocData").Rows(j).Item("leasetype") = "1554310" Then 'CAM
                                                    Dim names As List(Of String) = (From row In ds.Tables("AutoInvFieldData").AsEnumerable()
                                                                                    Select row.Field(Of String)("TDocType") Distinct).ToList()
                                                    ...
                                                    For f As Integer = 0 To names.Count - 1
                                                                ...
                                                                If ds.Tables("RDOCIDData").Rows.Count = 0 Then
                                                                    ...
                                                                    If CDate(LCAMComDate) = Date.Now Then 'date.now
                                                                        ...
                                                                        If res <> 0 Then
                                                                            ...
                                                                            Dim date2 As DateTime = Convert.ToDateTime(LSdate1.ToString("MM/dd/yy"))
                                                                            Dim LESCDate As Date = LeaseComDate
                                                                            LESCDate = CDate(LESCDate).ToString("dd/MM/yy")
                                                                            Dim FinalInvDate As String = String.Empty
                                                                            Dim MGAmtDT As Double
                                                                            Dim ParseDate As String = String.Empty
                                                                            If LRentFreedays = "0" Then
                                                                ...
                                                                ElseIf ds.Tables("RDOCIDData").Rows.Count > 0 And Convert.ToString(names(f)) = "CAM" Then
                                                                    ...
                                                                    If Convert.ToString(names(f)) = "CAM" Then
                                                                        ...
                                                                        If rowECD.Length > 0 Then
                                                                            ...
                                                                            Next
                                                                        End If
                                                                        da.SelectCommand.CommandText = "Select top 1 " & Fieldmap & "  as InvCreationDt," & ESCFieldmap & " as CAmEscDate from mmm_mst_doc with (nolock) where RDOCID=" & RDOCID & " and eid=" & EID & "  and Documenttype='" & Convert.ToString(names(f)) & "' order by tid desc "
                                                                    ...
                                                                    Dim Escdt As Date = Convert.ToDateTime(EscalationDate)
                                                                    Dim ESCFinaldateARR As String() = EscalationDate.Split("/")
                                                                    EscalationDate = CDate(ESCFinaldateARR(1) + "/" + ESCFinaldateARR(0) + "/" + ESCFinaldateARR(2)).ToString("dd/MM/yy")
                                                        ...
                                                        End If
                                                    Next
                                                ElseIf ds.Tables("AutoInvDocData").Rows(j).Item("leasetype") = "1570943" Then 'ALL
                                                    Dim names As List(Of String) = (From row In ds.Tables("AutoInvFieldData").AsEnumerable()
                                                                                    Select row.Field(Of String)("TDocType") Distinct).ToList()
    ...
    Public Function ParseEscDateFn(ByVal LRentPayment As String, ByVal date1 As Date, ByVal date2 As Date, ByVal MGAmount As Double) As String
        ...
        Result = Convert.ToString(FinalInvDate) + "=" + Convert.ToString(BESCTotalDays) + "=" + Convert.ToString(AESCTotalDays) + "=" + Convert.ToString(BdecimalVar) + "=" + Convert.ToString(dss)
                ...
                If Date.TryParse(dtss, DTS) Then
                    ...
                    Else
                        ...
                        Else
                            ...
                            Dim dt As Date = CDate(dtss)
                            ' lastDay = New DateTime(DTS.Year, DTS.Month - 1, DTS.Day)
                            lastDay = New Date(dt.Year, dt.Month, 1)
    ...
    Public Sub MGSalesInv()
        ...
        Try
            ...
            da = New SqlDataAdapter("DECLARE @DATE DATETIME,@LDocNo as nvarchar(200) ;SET @DATE= getdate(); select Tid, dms.udf_split('DOCUMENT-MOU Lease Document-fld50',fld1) [LeaseDocNo]," & strSFlds & " from MMM_MST_DOC with(Nolock)  where   documenttype='Sales Form' and  adate between @DATE-DAY(@DATE)+1 and EOMONTH(@DATE);", con)

            da.Fill(ds, "SalesInvDAta")
            AutoRunLog("Run_FTP_Inward_Integration", "AutoMGSalesInvoice", "Calling AutoMGSalesInvoice Function Now 1", 181)
                        ...
                        If ds.Tables("RentalInvData").Rows.Count <> 0 Then
                            ...
                            For j As Integer = 0 To ds.Tables("RentalInvData").Rows.Count - 1
                                ...
                                If MGDOCIDData.Rows.Count > 0 Then
                                    MGDOCIDData.Clear()
                                End If
                                da.SelectCommand.CommandText = "DECLARE @DATE DATETIME ;SET @DATE= getdate()-3; select * from MMM_MST_DOC where fld16='" & Convert.ToString(ds.Tables("RentalInvData").Rows(j).Item("Rental Invoice No")) & "' and documenttype='" & Convert.ToString(Documenttype) & "'  and  adate between @DATE-DAY(@DATE)+1 and EOMONTH(@DATE);"
                                ...
                                If ds.Tables("MGDOCIDData").Rows.Count = 0 Then
                                    If ds.Tables("RentalInvData").Rows(j).Item("LeaseType") = "1491591" Or ds.Tables("RentalInvData").Rows(j).Item("LeaseType") = "1554309" Or ds.Tables("RentalInvData").Rows(j).Item("LeaseType") = "1570941" Or ds.Tables("RentalInvData").Rows(j).Item("LeaseType") = "1570943" Then
                                        ...
                                        da.SelectCommand.CommandText = "select * from MMM_MST_DOC where RDOCID=" & ds.Tables("RentalInvData").Rows(j).Item("Tid") & " and documenttype='" & Convert.ToString(Documenttype) & "';"
                                        da.SelectCommand.CommandType = CommandType.Text
                                        da.Fill(ds, "RDOCIDData")
                                        RDOCIDData = ds.Tables("RDOCIDData")
                                        If ds.Tables("RDOCIDData").Rows.Count = 0 Then
                                            ...
                                            SValue = ds.Tables("SalesInvDAta").Rows(i).Item("MG Sales Value")
                                            ...
                                            If IsDBNull(ds.Tables("RentalInvData").Rows(j).Item("MG Amount")) = True Then
                                                LRentInvAmt = 0
                                            Else
                                                LRentInvAmt = Convert.ToDouble(ds.Tables("RentalInvData").Rows(j).Item("MG Amount"))
                                            End If

                                            Rent_Period_From = ds.Tables("RentalInvData").Rows(j).Item("Lease Start Date")
                                            Rent_Period_Till = ds.Tables("RentalInvData").Rows(j).Item("Lease End Date")
                                            ...
                                            If Result = True Then
                                                ...
                                                'calculeting Varience 
                                                SVarience = SValue - LRentInvAmt
                                                ...
                                                If SVarience <> 0 Then
                                                    ...
                                                    If FieldData.Rows.Count > 0 Then
                                                        FieldData.Clear()
                                                    End If
                                                    insStr = "insert into MMM_MST_DOC (documenttype,EID,ISAUTH,ADATE,CREATEDON,LASTUPDATE,OUID,RDOCID,fld4,fld19,fld9, fld10,fld12,fld13,fld14,fld15,fld16,fld18,fld20) values ('" & Documenttype & "','" & EID & "',1,getdate(),getdate(),getdate(),'30200','" & ds.Tables("SalesInvDAta").Rows(i).Item("Tid") & "','" & Store_Code & "','" & Store_Name & "','" & Rent_Period_From & "','" & Rent_Period_Till & "','" & LRentInvAmt & "','" & SValue & "','" & SVarience & "','" & Lease_Doc_No & "','" & Rent_Invoice_No & "','" & Department & "','" & SReveSharingptage & "');"
                                                    ...
                                                    If res <> 0 Then
                                                        ...
                                                        '' insert default first movement of document  
                                                        da.SelectCommand.CommandText = "InsertDefaultMovement"
                                                        da.SelectCommand.CommandType = CommandType.StoredProcedure
                                                        da.SelectCommand.Parameters.Clear()
                                                        da.SelectCommand.Transaction = tran
                                                        ...
                                                        tran.Commit()
                                                        AutoRunLog("Run_FTP_Inward_Integration", "AutoMGSalesInvoice created", "Calling AutoMGSalesInvoice Function Now 1", 181)
                                                        'Non transactional Query
                                                        'Check Work Flow
                                                        ...
                                                        Try
                                                            ...
                                                            If ds.Tables("AutoInvSettingData").Rows.Count <> 0 Then
                                                                For i As Integer = 0 To ds.Tables("AutoInvSettingData").Rows.Count - 1
                                                                    ...
                                                                    ' da.SelectCommand.Transaction = tran
                                                                    da.Fill(ds, "AutoInvFieldData")
                                                                    If ds.Tables("AutoInvFieldData").Rows.Count <> 0 Then

                                                                        Dim namesInv As List(Of String) = (From row In ds.Tables("AutoInvFieldData").AsEnumerable()
                                                                                                           Select row.Field(Of String)("TDocType") Distinct).ToList()

                                                                        For Inv As Integer = 0 To namesInv.Count - 1
                                                                            If namesInv(Inv) = "Rental Invoice" Then

                                                                                Dim dvsInv As DataView = ds.Tables("AutoInvFieldData").DefaultView
                                                                                ...
                                                                                If filteredTable.Rows.Count <> 0 Then
                                                                                    ...
                                                                                    strHSFldsArrInv = strSFlds.Split(",")
                                                            ...
                                                            Call AutoInvoiceAmendLease(MasterTid:=ds.Tables("MasterDAta").Rows(j).Item("Tid"), Doctype:="Lease Master", LessorsMGAmt:=TotalMGAmt, value:=value, RDOCID:=RDOCID, FieldData:=FieldData, strTFlds:=strTFlds, con:=con, tran:=tran)
                                                        Catch ex As Exception
    ...
    Protected Sub AutoInvoiceAmendLease(ByVal MasterTid As String, ByVal Doctype As String, ByVal LessorsMGAmt As Double, ByVal RDOCID As String, ByVal value As String, ByVal strTFlds As String, FieldData As DataTable, ByVal con As SqlConnection, ByVal tran As SqlTransaction)
                                ...
                                If names(f) = "Rental Invoice" Then
                                    ...
                                    If LRenttype = 1554651 Or LRenttype = 1554653 Then 'Fixed And Revenue Sharing  Then 'Fixed
                                        ...
                                        If res <> 0 Then
                                            ...
                                            Dim rowMGAmt As DataRow() = FieldData.Select("DisplayName='MG Amount'  and Datatype='Numeric'")
                                            If rowMGAmt.Length > 0 Then
                                                For Each CField As DataRow In rowMGAmt
                                            ...
                                            'Lease Period Start	
                                            'InvGenDate = CDate(InvGenDate).ToString("dd/MM/yy")
                                            Dim LSPARR As String() = AlreadyEistData.Rows(0).Item("InvCreationDt").Split("/")
                                            InvGenDate = LSPARR(1) + "/" + LSPARR(0) + "/" + LSPARR(2)
                                            InvGenDate = CDate(InvGenDate).ToString("dd/MM/yy")
