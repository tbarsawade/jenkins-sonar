<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="PayUPRToInvRptNew, App_Web_i1zxh3rv" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetReport() {
            ...
            $.ajax({
                type: "POST",
                url: "PayUPRToInvRptNew.aspx/GetData",
                data: str,
    ...
    <div class="container-fluid">      
        <div class="form" style="text-align: left">
            <div class="doc_header">
                PR To PO To Invoice Status Report
            </div>
            <div class="row mg">
