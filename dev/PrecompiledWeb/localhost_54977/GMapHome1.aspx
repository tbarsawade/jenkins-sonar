<%@ page language="VB" autoeventwireup="false" masterpagefile="~/PublicMaster.master" inherits="GMapHome1, App_Web_ws3kahym" enableeventvalidation="false" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script src="js/Gmap%201.js"></script>
  ...
  border: 1px solid rgba(81, 203, 238, 1);
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            Gmap1.GetMarkers('<%= Circle.ClientID%>', '<%= chkvtype.ClientID%>');
                 ...
                 <table style="width: 100%; height: 670px;">
                    <tr>
                        ...
                        <td style="width: 87%; height: 770px;" valign="top" >
                            <div id="map" style="width: 100%; text-align:center;vertical-align:middle ;height: 100%;">
