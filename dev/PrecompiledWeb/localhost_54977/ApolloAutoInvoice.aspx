<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="ApolloAutoInvoice, App_Web_2echgblw" viewStateEncryptionMode="Always" %>
    ...
    <br />
        ...
        <table>
            ...
            <tr>
                <td></td>
                <td></td>
                <asp:Button ID="btnAutoInvManual" runat="server" Text="Auto Lease Invoice Creation" style="margin-left: 323px; margin-top: 34px;" Width="250px"  />
                <td></td>
                <td></td>
            </tr>
            <tr>
