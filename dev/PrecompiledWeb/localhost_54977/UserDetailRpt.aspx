<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="UserDetailRpt, App_Web_fdh01zus" viewStateEncryptionMode="Always" %>
    ...
    <script type="text/javascript">
        ...
        function GetReport() {
           ...
           // $("#kgrid").html('');
            ...
            $.ajax({
                type: "POST",
                url: "UserDetailRpt.aspx/GetData",
                data: str,
