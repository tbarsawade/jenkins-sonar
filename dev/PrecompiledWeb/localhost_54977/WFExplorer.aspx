<%@ page title="Work Flow Explorer" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="WFExplorer, App_Web_i1zxh3rv" viewStateEncryptionMode="Always" %>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                               <asp:ImageButton ID="btnView" ImageUrl="~/images/view.png"  runat="server" Height="16px" Width="16px" OnClick="ShowHit"  ToolTip="View / Download File"/>
                                 &nbsp;
                                 <a class="detail" style=" text-decoration:none;" href="#"  onclick="OpenWindow('DocDetail.aspx?DOCID=<%# DataBinder.Eval(Container.DataItem, "docid")%>')" >
