<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="Rockman_Advance_Req_Report, App_Web_ws3kahym" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetReport() {
            var reportid = "2145"; //$("#ddlReportName").val();
            if (reportid == "") {
            ...
            $.ajax({
                type: "POST",
                url: "Rockman_Advance_Req_Report.aspx/GetData",
                data: str,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: BindReport,
