<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="TripReport, App_Web_oxlb5fhs" enableeventvalidation="false" viewStateEncryptionMode="Always" %>
                ...
                <table cellpadding="5px" cellspacing="5px" style="width: 100%; border: solid; color: blue;
                    ...
                    <tr>
                        <td colspan="6" style="text-align: center">
                            <asp:Label ID="lblHeader" runat="server" Text="IMEI Wise Signal Report " Style="font-weight: bold;
