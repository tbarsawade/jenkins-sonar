<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="GRNStatusReport, App_Web_4ysr50e5" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetReport() {
            ...
            var OperatingUnit = "";
            $("#kgrdtl").html("");
            var str = '{"sdate": "' + t1 + '", "edate": "' + t2 + '","Reportid": "' + ReportID + '","OperatingUnit": "' + OperatingUnit + '"}';
            $.ajax({
                type: "POST",
                url: "GRNStatusReport.aspx/GetData",
                data: str,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: BindReport,
