<%@ page title="" language="VB" masterpagefile="~/PublicMaster.master" autoeventwireup="false" inherits="Test, App_Web_ws3kahym" viewStateEncryptionMode="Always" %>
                ...
                $.each(obj, function (i, value) {
                    ...
                    if (value.Site.toUpperCase() == 'HUB') {
                       ...
                       // this['IsCluster'] = contains ? true : false;
                        ...
                        this['Information'] = "<span> SiteID : " + value.SiteID + "</span><br>Site : " + value.Site + "<br>Site Name : " + value.Site_Name + "<br>OandM Head: " + value.OandM_Head + " <br> Maintenance Head : " + value.Maintenance_Head + " <br>Opex Manager : " + value.Opex_Manager + "<br>Security Manager : " + value.Security_Manager + "<br>Zonal Head : " + value.Zonal_Head + "<br>Cluster Manager :" + value.Cluster_Manager + "<br>Supervisor : " + value.Supervisor + "<br>Technician : " + value.Technician + "<br>No of OPCOs : " + value.No_of_OPCOs + " <br>Anchor OPCO : " + value.Anchor_OPCO + "";
                        this['Lat'] = value.Lat;
                        this['Long'] = value.Long;
                       ...
                       // this['IsCluster'] = contains ? true : false;
                        ...
                        this['Information'] = "<span> SiteID : " + value.SiteID + "</span><br>Site Name : " + value.Site_Name + "<br>OandM Head: " + value.OandM_Head + " <br> Maintenance Head : " + value.Maintenance_Head + " <br>Opex Manager : " + value.Opex_Manager + "<br>Security Manager : " + value.Security_Manager + "<br>Zonal Head : " + value.Zonal_Head + "<br>Cluster Manager :" + value.Cluster_Manager + "<br>Supervisor : " + value.Supervisor + "<br>Technician : " + value.Technician + "<br>No of OPCOs : " + value.No_of_OPCOs + " <br>Anchor OPCO : " + value.Anchor_OPCO + "";
                        this['Lat'] = value.Lat;
                        this['Long'] = value.Long;
            ...
            try {
                ...
                function addInfoBubble() {
                    ...
                    for (var i = 0; i < data.length - 1; i++) {
                        ...
                        { continue; }
                        var bearsIcon = new H.map.Icon(data[i].img);

                        var bearsMarker = new H.map.Marker({ lat: x, lng: y },
                            { icon: bearsIcon },{ group: data[i]['Group']});
