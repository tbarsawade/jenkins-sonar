 <%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="IndusHome, App_Web_2echgblw" viewStateEncryptionMode="Always" %>
                             ...
                             <colgroup style="width:40%; "></colgroup>
                                ...
                                <tr>
                                   ...
                                   <td style="text-align:center; vertical-align:middle;">
                                    ...
                                    <td>
                                        &nbsp;Zonal Head, Technical Manager, Cluster Manager</td>
                                </tr>
                                <tr>
                                    <td style="text-align:center;">
    ...
    <script  type="text/javascript" charset="UTF-8" >
        ...
        var ui;
         ...
         function ShowMap(ddlsite, ddlVechical) {
             ...
             $.ajax({
                 type: "post",
                 url: "IndusHome.aspx/GetMarkerListJSON2",
                 data: '{IDs: "' + str + '" }',
                 ...
                 function addInfoBubble() {
                     ...
                     for (var i = 0; i < data.length - 1; i++) {
                         ...
                         group.addEventListener('tap', function (evt) {
                             ...
                             $.ajax({
                                 type: "post",
                                 url: "IndusHome.aspx/GetMarkerInfo",
        ...
        function GetNewMarker() {
            ...
            $.ajax({
                type: "POST",
                url: "IndusHome.aspx/RefreshVechicals",
                data: '{IDs: "' + str + '" }',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
