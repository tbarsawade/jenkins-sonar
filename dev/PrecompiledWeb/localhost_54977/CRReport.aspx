<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="CRReport, App_Web_i1zxh3rv" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetReport() {
            ...
            var str = '{ "d1": "' + $("#ddlStatus").val() + '","uid":"'+UID+'","urole":"'+URole+'"}';
            //  var dslipnum = $('#txtDslip').val();
            $.ajax({ 
                type: "POST",
                url: "CRReport.aspx/GetDSlip",
                data: str,
   ...
   <div style="width:100%;height:47px;padding-top:15px;padding-left:10px;font:bold 17px 'verdana';color:#fff;background-image:url(logo/hfclstrip.jpg);background-repeat:no-repeat">Change Request Report</div>
    <br />
       <div id="divFilters">
