<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="AttendanceReport, App_Web_qpjniz5y" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetReport() {
            ...
            $.ajax({
                type: "POST",
                url: "AttendanceReport.aspx/GetData",
                data: str,
        ...
        function GetBusinessUnit() {
            ...
            $.ajax({
                type: "POST",
                url: "AttendanceReport.aspx/GetBusinessUnit",
                contentType: "application/json; charset=utf-8",
                data: str,
                dataType: "json",
        ...
        function Export() {
            ...
            $.ajax({
                type: "POST",
                url: "AttendanceReport.aspx/GetExport",
                data: str,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: BindExl,
