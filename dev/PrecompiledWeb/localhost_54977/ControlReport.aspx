<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="ControlReport, App_Web_qpjniz5y" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetReport() {
            ...
            $.ajax({
                type: "POST",
                url: "ControlReport.aspx/GetData",
                data: str,
        ...
        function GetBusinessUnit() {
            ...
            $.ajax({
                type: "POST",
                url: "ControlReport.aspx/GetBusinessUnit",
                contentType: "application/json; charset=utf-8",
                data: str,
                dataType: "json",
        ...
        function Export() {
            ...
            $.ajax({
                type: "POST",
                url: "ControlReport.aspx/GetExport",
                data: str,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: BindExl,
...
function btnExport_onclick() {
    ...
    <div style="width: 100%; height: 47px; padding-top: 15px; padding-left: 10px; font: bold 17px 'verdana';
        ...
        <asp:Label runat="server" ID="lblReport"></asp:Label></div>
    <br />
