<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="InvoiceRejectionResolution, App_Web_i1zxh3rv" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetReport() {
            ...
            $.ajax({
                type: "POST",
                url: "InvoiceRejectionResolution.aspx/GetData",
                data: str,
    ...
    <div class="container-fluid">      
        <div class="form" style="text-align: left">
            <div class="doc_header">
               Invoice Rejection Resolution Report
            </div>
            <div class="row mg">
