...
Partial Class POAgeingPTM
    ...
    Public Shared Function GetData(sdate As String, edate As String, PRNO As String, CreatedBy As String, Department As String, Status As String, Entity As String, Vendor As String) As DGrid
        ...
        Try
            ...
            Dim ds As New DataSet()
            Dim qry As String = ""
            da.SelectCommand.CommandText = "POAgeingReport_PTM"
            ...
            '    da.SelectCommand.CommandText = "select qryfield[cmd] from mmm_mst_report with(nolock) where reportid=2115"
            'Else
            '    da.SelectCommand.CommandText = "select qryfieldrole[cmd] from mmm_mst_report with(nolock) where reportid=2115"
            'End If
            'da.Fill(ds, "qry")
