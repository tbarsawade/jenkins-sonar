...
Public Interface IBPMTallyWS
    ...
    <OperationContract> _
   <WebInvoke(Method:="POST", requestformat:=WebMessageFormat.Xml, responseformat:=WebMessageFormat.Xml, UriTemplate:="/REGISTRATION")> _
    Function REGISTRATION(Data As Stream) As XElement
