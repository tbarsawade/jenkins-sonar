    ...
    Sub OutwardSoapWebServiceProcess(ByVal ds As System.Data.DataSet, ByVal methodName As String)
        ...
        Try
            ...
            If rows(0)("SendTo").ToString.ToUpper = "USER" Then
                ...
                Dim query As String = rows(0)("reportquery").ToString()
