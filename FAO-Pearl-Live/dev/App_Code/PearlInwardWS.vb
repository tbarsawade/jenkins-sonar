...
Public Class PearlInwardWS
    ...
    Public Function GenerateToken(ByVal userDetails As APIUserDetails) As PearlResponseData
        ...
        Return responseData
    End Function
    Private Function ValidateToken(ByVal Token As String) As PearlResponseData
        Dim responseData As PearlResponseData = New PearlResponseData
        Dim dataClass As New DataClass()
        Dim dt As DataTable = dataClass.ExecuteQryDT("select EID,UserId,TokenId,TokenExpiredDate from mmm_mst_entity where TokenId='" & Token & "' and eid=209 ")
        If dt.Rows.Count > 0 Then
