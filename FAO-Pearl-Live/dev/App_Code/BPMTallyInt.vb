...
Imports System.Xml
Public Class BPMTallyInt
    Implements IBPMTallyInt
    '    Dim conStr As String = ConfigurationManager.ConnectionStrings("conStr").ConnectionString
    Dim BPMKEY As String = ConfigurationManager.AppSettings("BPMKEY").ToString()

    Function INWARD(Data As Stream) As XElement Implements IBPMTallyInt.INWARD
        Dim Result = ""
        Dim msg As String = ""
    ...
    Function OUTWARD(Data As Stream) As XElement Implements IBPMTallyInt.OUTWARD
    ...
    Function REGISTER(Data As Stream) As XElement Implements IBPMTallyInt.REGISTER
        Dim Result = ""
    ...
    Function CONFIRMATION(Data As Stream) As XElement Implements IBPMTallyInt.CONFIRMATION
        Dim Result = ""
        Try
            Dim reader As New StreamReader(Data)
            Dim strData As String = reader.ReadToEnd()
    ...
    Function UPDATIONFLAG(Data As Stream) As XElement Implements IBPMTallyInt.UPDATIONFLAG
        Dim Result = ""
        Dim msg As String = ""
        Dim Key As String = "", EID As String = "", DocType As String = "", UID As String = 0
        Try
