<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="CbInvNonPOJVReport, App_Web_tuuwcp04" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetReport() {
            ...
            $.ajax({
                type: "POST",
                url: "CbInvNonPOJVReport.aspx/GetData",
                data: str,
