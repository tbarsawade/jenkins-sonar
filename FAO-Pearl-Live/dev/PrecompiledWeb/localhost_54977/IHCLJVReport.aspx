<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="IHCLJVReport, App_Web_ju5zdh34" viewStateEncryptionMode="Always" %>
   ...
   <%-- <script src="js/gridviewScroll.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function getReport() {
            ...
            //var obj = Rc.getData();
            var str = '{ "stdate": "' + Sdate + '", "edate": "' + Edate + '"}';
            $.ajax({
                type: "POST",
                url: "IHCLJVReport.aspx/GetData",
                data: str,
