<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="MIS_DashBoard_Config, App_Web_0xvfyc51" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-3">
                            <asp:DropDownList ID="ddlField" runat="server" CssClass="txtBox">
                                <asp:ListItem Text="DBName">Chart Name</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="col-md-1 col-sm-1">
                            <label>Value</label>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <asp:GridView ID="gvDashboardData" runat="server" AutoGenerateColumns="false" CellPadding="2"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Tid" HeaderText="TID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol">
        ...
        <div>
            <div class="container-fluid">
                <div class="doc_header">
                    ...
                    <div style="float: right;">
                        <asp:ImageButton ID="imgcloseedit" CssClass="PopUpCloseBtn" AlternateText="close button" runat="server" ImageUrl="images/close.png"  OnClientClick="document.location.reload(true)" />
                    </div>
                </div>
            </div>
                                ...
                                <thead>
                                    <tbody>
                                        ...
                                        <tr runat="server">
                                            ...
                                            <td id="lblinvtype" runat="server"><label>InvoiceType Field </label></td>
                                            <td id="ddlInvtype" runat="server">
                                                <asp:DropDownList ID="ddlinvtypevendor" runat="server" OnSelectedIndexChanged="ddlinvtypevendor_SelectedIndexChanged" AutoPostBack="true" CssClass="txtBox"></asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr id="InvType" runat="server">
                                            <td>
                                                <label>PO Type Field</label>
                                            </td>
                                            <td id="Td3" runat="server">
                                                <asp:DropDownList ID="ddlpoType" runat="server" CssClass="txtBox"></asp:DropDownList>
                                            </td>
                                            <td id="Td1" runat="server"><label>Non PO Type Field</label></td>
                                            <td id="Td2" runat="server">
                                                <asp:DropDownList ID="ddlnonpotype" runat="server" CssClass="txtBox"></asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <asp:DropDownList ID="ddltype" runat="server" CssClass="txtBox" OnSelectedIndexChanged="ddltype_SelectedIndexChanged" AutoPostBack="true">
                                        ...
                                        <tr id="trvndrinvval" runat="server">
                                            <td>
                                                <label>PO Value Fields</label>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlPofields" runat="server" CssClass="txtBox" AutoPostBack="true" OnSelectedIndexChanged="ddlPofields_SelectedIndexChanged"></asp:DropDownList>
                                            </td>
                                            <td>
                                                <label>NonPo Value Fields</label>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlnonpodate" runat="server" CssClass="txtBox"></asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="6">
                                                <asp:HiddenField ID="hdnchilddetailReftid" runat="server" />
                                                <asp:GridView ID="gridchilditemdata" runat="server" AutoGenerateColumns="false" CellPadding="2"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="RefTid" HeaderText="Ref TID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol">
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="CatField" HeaderText="Category">
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="ValueField" HeaderText="Value Field">
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="RecdateField" HeaderText="Recieve Date Field">
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="InvDateField" HeaderText="Invoice Date Field">
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <asp:TemplateField HeaderText="Action">
                                                            <ItemTemplate>
                                                                ...
                                                                &nbsp;
                                                                <asp:ImageButton ID="imgDeletechild" runat="server" ImageUrl="~/images/Delete.gif" Height="16px" Width="16px" ToolTip="Delete Record" AlternateText="Delete Record" OnClientClick="return confirm('Are you sure you want to delete this entry?');" OnClick="imgDeletechild_Click" />
                                                        ...
                                                        <tr>
                                                            <td colspan="8" align="center">
                                                                <asp:GridView ID="Griddatediff" runat="server"
                                                                    AutoGenerateColumns="false" ForeColor="#333333" Width="100%" AllowSorting="True"  EmptyDataText="No records has been added." DataKeyNames="Tid">
                                                                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                                                    <RowStyle BackColor="#EFF3FB" />
                                                                    <EditRowStyle BackColor="#2461BF" />
                                                                    <SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="Tid" HeaderText="Tid" ItemStyle-Width="50" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol">
                                                                            <HeaderStyle HorizontalAlign="Left" />
                                                                        </asp:BoundField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Action" ItemStyle-Width="50">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="imgDelete" runat="server" ImageUrl="~/images/Delete.gif" Height="16px" Width="16px" ToolTip="Delete Record" AlternateText="Delete Record" OnClientClick="return confirm('Are you sure you want to delete this entry?');" OnClick="imgDelete_Click" />
                                                                                &nbsp;
                                                                             <%--<asp:ImageButton ID="EditshowdetailItem" runat="server" ImageUrl="~/images/edit.jpg" Height="16px" Width="16px" ToolTip="Show Detail Fields" AlternateText="Show Detail Item Fields"  />--%>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>            
                                                                    </Columns>
                                                                    <SortedAscendingCellStyle BackColor="#EDF6F6" />
        ...
        <div>
            <div class="container-fluid">
                <div class="doc_header">
                    ...
                    <div style="float: right;">
                        <asp:ImageButton ID="imgclosechildshow" CssClass="PopUpCloseBtn" AlternateText="close button" runat="server" ImageUrl="images/close.png"  OnClientClick="document.location.reload(true)" />
                    </div>
                </div>
            </div>
    ...
    <asp:Panel ID="pnladddetailsitem" runat="server" Width="1000px" BackColor="#FFFFFF" Height="500px" Style="overflow: scroll">
        <div>
            <div class="container-fluid">
                <div class="doc_header">
                    Add/Update Detail Fields
                    <div style="float: right;">
                        <asp:ImageButton ID="ImageButton1" CssClass="PopUpCloseBtn" AlternateText="close button" runat="server" ImageUrl="images/close.png"  OnClientClick="document.location.reload(true)" />
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    <tr id="tr1" runat="server">
                                        ...
                                        <td>
                                            ...
                                            <asp:HiddenField ID="fieldhdndisplayname" runat="server" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="Dropdowntype" runat="server" CssClass="txtBox" AutoPostBack="true" OnSelectedIndexChanged="Dropdowntype_SelectedIndexChanged">
                                                <asp:ListItem>Department</asp:ListItem>
                                                <asp:ListItem>Expence Nature</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="8" align="center">
                                            <asp:HiddenField ID="hdngridviewdetailReftid" runat="server" />
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action">
                                                        <ItemTemplate>
                                                            ...
                                                            &nbsp;
                                                            <asp:ImageButton ID="imgDetailItemDelete" runat="server" ImageUrl="~/images/Delete.gif" Height="16px" Width="16px" ToolTip="Delete Record" AlternateText="Delete Record" OnClientClick="return confirm('Are you sure you want to delete this entry?');" OnClick="imgDetailItemDelete_Click"/>
                                                        </ItemTemplate>
                                                        <ItemStyle Width="90px" HorizontalAlign="Center" />
                                                    </asp:TemplateField>
                                                </Columns>
