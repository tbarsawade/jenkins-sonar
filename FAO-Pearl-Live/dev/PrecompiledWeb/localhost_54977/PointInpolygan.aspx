<%@ page language="VB" autoeventwireup="false" inherits="PointInpolygan, App_Web_3z3tajeu" viewStateEncryptionMode="Always" %>
<!DOCTYPE html>
       ...
       function MyndMap()
        {
            $.ajax({
                type: "post",
                url: "PointInpolygan.aspx/ConvertDataTabletoString",
                data: "{}",
...
<script type="text/javascript">
    ...
    function initialize() {
        ...
        var mapProp = {
            center: new google.maps.LatLng(19.1754, 72.8489),
            zoom: 10,
