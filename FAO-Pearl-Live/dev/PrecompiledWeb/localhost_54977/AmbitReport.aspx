<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="AmbitReport, App_Web_20pgc3v0" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container-fluid">      
        <div class="form" style="text-align: left">
            ...
            <div class="row mg">
                <div class="col-md-2 col-sm-2">
                    <label id ="lblFromDate">Invoice From Date</label>
                </div>
                <div class="col-md-3 col-sm-3">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#ddlReportName").change(function () {
                ...
                if (reportid == "2146" || reportid == "2148" || reportid == "2149") {
                    $("#dvVendorCode,#dvInvoiceToDate").hide();
                    $("#lblFromDate").html("Report Date");
                }
                else {
                    $("#dvVendorCode,#dvInvoiceToDate").show();
                    $("#lblFromDate").html("Invoice From Date");
                }
            });
        });
