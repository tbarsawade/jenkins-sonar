<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="logbookreport, App_Web_wzrtint1" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function MyChart() {
            ...
            $.ajax({
                type: "post",
                url: "Nightlogbookreport.aspx/GetJSON",
                data: t,
        ...
        function MyGrid() {
            ...
            $.ajax({
                type: "GET",
                url: "NightLogbook.svc/GetlogBook",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: t11,
                ...
                columns: [{
                    ...
                    title: "Circle"
...

                             {
                                 ...
                                 field: "Start_Date",
                                 title: "Movment Start Date Time",
                                 format: "{0:dd-MMM-yyyy hh:mm:ss tt}",
                                 parseFormats: ["yyyy-MM-dd'T'HH:mm:ss.zz"]
                             }
                             , {
                                 field: "End_Date",
                                 title: "Movment End Date Time",
                                 format: "{0:dd-MMM-yyyy hh:mm:ss tt}",
                                 parseFormats: ["yyyy-MM-dd'T'HH:mm:ss.zz"]
                             }
                             ,  {
