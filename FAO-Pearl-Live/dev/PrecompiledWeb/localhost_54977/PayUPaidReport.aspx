<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="PayUPaidReport, App_Web_tuuwcp04" viewStateEncryptionMode="Always" %>
   ...
   <%-- <script src="js/gridviewScroll.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function getReport() {
            ...
            var year = $("#ContentPlaceHolder1_ddlyear option:selected").text();
            ...
            $.ajax({
                type: "POST",
                url: "PayUPaidReport.aspx/GetData",
                data: str,
                                ...
                                <div class="form" style="text-align: left">
                                    ...
                                    <div class="row mg">
                                       ...
                                       <div class="col-md-2 col-sm-2">
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                            <asp:DropDownList ID="ddlyear" runat="server" AutoPostBack="true"  CssClass="txtBox">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-md-2 col-sm-2">
