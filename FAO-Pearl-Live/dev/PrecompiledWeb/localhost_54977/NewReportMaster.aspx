<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="NewReportMaster, App_Web_m0o4zmkn" enableeventvalidation="false" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script src="js/ReadControles.js"></script>
    ...
    <asp:UpdatePanel ID="updPnlGrid" runat="server">
        ...
        <ContentTemplate>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div id="tabstrip" >
                                            ...
                                            <div style="">
                                                <div id="Chart0" style="height:350px!important"></div>
                                            </div>
                                            <div style=""><div id="Chart1" style="height:350px!important"></div></div>
                                            <div style=""><div id="Chart2" style="height:350px!important"></div></div>
                                            <div style=""><div id="Chart3" style="height:350px!important"></div></div>
                                            <div style=""><div id="Chart4" style="height:350px!important"></div></div>
                                        </div>

                                        <div style="max-width: 1000px; max-height: 250px; overflow-x: scroll;">
            ...
            <%--Graph Properties--%>
            <asp:Panel runat="server" ID="pnlchart" Width="960px" Style="display: none;" Height="400px">
