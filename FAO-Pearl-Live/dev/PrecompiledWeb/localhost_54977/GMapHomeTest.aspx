<%@ page language="VB" autoeventwireup="false" masterpagefile="~/PublicMaster.master" inherits="GMapHomeTest, App_Web_gsdfcjye" enableeventvalidation="false" viewStateEncryptionMode="Always" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script src="Scripts/jquery-1.9.1.min.js"></script>
    <script src="js/GmapTest.js"></script>
  ...
  border: 1px solid rgba(81, 203, 238, 1);
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            GmapTest.GetMarkers('<%= Circle.ClientID%>', '<%= chkvtype.ClientID%>');
            CacheValues();
            var map;
        });
                            ...
                            <div style="width: 100%; height: 770px;" >
                                ...
                                <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="images/ref.png" id="img2" onclick="GmapTest.RefreshVechical1(this,'img1');" title="Refresh Vechicals" style="width:25px; height:25px; cursor:pointer;" />
                                ...
                                <legend style="color: Black; text-align: Left; font-weight: bold;">Search Sites</legend>
                                        <input type="text" id="txtSearchV" style="width:96%; " placeholder="Type Site Name" onkeyup="return GmapTest.SearchSite(this,'#idSite',false);"  />
                                <input type="text" id="txtSearchId" style="width:96%; " placeholder="Type SiteID" onkeyup="return GmapTest.SearchSite(this,'#idSite',true);"  />
                        ...
                        <td valign="top"  >
                         <table cellspacing="0" celpadding="0" width="100%" border="1" style=" vertical-align:middle;">
                             ...
                             <colgroup style="width:40%; "></colgroup>
                                ...
                                <tr>
                                    <td style="text-align:center;">
                                        <asp:Image ID="Image7" runat="server" ImageUrl="http://www.myndsaas.com/images/darkk.png" />
                                    </td>
                                    <td>
                                        &nbsp; Non Strategic</td>
                                    <td style="text-align:center; vertical-align:middle;">
