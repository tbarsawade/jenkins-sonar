<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="TripReport, App_Web_0xvfyc51" enableeventvalidation="false" viewStateEncryptionMode="Always" %>
    ...
    <div>
        <asp:UpdatePanel ID="updPnlSearch" runat="server">
                ...
                <table cellpadding="5px" cellspacing="5px" style="width: 100%; border: solid; color: blue;
                    ...
                    <tr>
                        <td colspan="3" style="text-align: center">
                            <asp:Label ID="lblHeader" runat="server" Text="IMEI's GPS Half Hourly Report" Style="font-weight: bold;
          ...
          <asp:Label ID="lblmsg" runat="server" Font-Bold="true" ForeColor="Red"  ></asp:Label>
                    ...
                    <tr>
                       <td colspan="3">
                            <asp:Panel ID="pnlgrd" runat="server"  ScrollBars="Both" Width="1000px" Visible="false"  >
                            <asp:GridView ID="GPSReport"  runat="server" PageSize="18"     
