<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="TabAttendanceReport, App_Web_bv10wntb" enableeventvalidation="false" viewStateEncryptionMode="Always" %>
              ...
              <td align="left" class="style2">
                  <table   >
                      <tr>
                        ...
                        <legend style=" color:Black; text-align:left;font-weight:bold; "><asp:CheckBox ID="CheckBox1"  OnCheckedChanged="checkuncheck" AutoPostBack="true"  runat="server" />User-IMIE No.</legend>
