<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="VehicleFenceINOutRpt, App_Web_4pl2ohtp" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="gradientBoxesWithOuterShadows" id="div1" style="margin-top:10px" >
       <asp:UpdatePanel runat="server" > <Triggers>
                            ...
                            <td  >
                                <fieldset style="width:326px; height:170px;" >
                                    ...
                                    <table >
                                        <tr>
                                            <td>
                                                ...
                                                <%--&nbsp;&nbsp;From Date:&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtsdate" AutoPostBack="false" onkeypress="return false;" runat="server"></asp:TextBox><asp:ImageButton ID="IBtnFromDt" runat="server" ImageUrl="~/images/cal.png" />
                                   ...
                                   <table style="width:100%;">
                                        ...
                                        <tr>
                                            <td width="30%" valign="bottom" style="padding-left: 10px">&nbsp;</td>
    ...
    <script language="javascript" type ="text/javascript" >
        ...
        function MyGrid() {
            ...
            { $("[id$='lblmsg']").html("Report for maximum 31 days can only be retrived."); }
                ...
                $("[id$='lblmsg']").html("");
                $("[id$='btnExcelExport']").visible = true;
                ...
                $.ajax({
                    type: "post",
                    url: "VehicleFenceINOutRpt.aspx/FillGrid",
        ...
        function bindGrid(Data1) {
            try{
                ...
                dataSource: {
                    ...
                    toolbar: ["excel"],
                    excel: {
                        fileName: "VehicleFenceReport.xlsx",
                        filterable: true,
                        pageable: true,
                        allPages: true
                    }
                    ...
                    columns: [
                        {
                         ...
                         {
                             field: "Trip_Start_Location",
                             title: "Origination"

                         },
                         {
                            field: "Trip_End_Location",
                            title: "Destination"
                         },
                         {
                                     field: "StartTime",
                                 ...
                                 {
                                     field: "TimeOUTFence",
                                     title: "Duration other than Geofence Area"

                                 },

                                {
                                    field: "TimeINFence",
                                    title: "Duration in Geofence Area"
