<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="InvoicePOReport_194, App_Web_m0o4zmkn" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetReport() {
            var t1 = $("#txtd1").val();
            var t2 = $("#txtd2").val();
            var reportName = document.getElementById('ContentPlaceHolder1_ddl_reportName')
            var reportID = reportName.options[reportName.selectedIndex].value ? reportName.options[reportName.selectedIndex].value : 0;
            $("#kgrdtl").html('');
            var str = '{"sdate": "' + t1 + '", "edate": "' + t2 + '","reportID":"' + reportID+'"}';

            $.ajax({
                type: "POST",
                url: "InvoicePOReport_194.aspx/GetData",
                data: str,
    ...
    <div class="container-fluid">      
        <div class="form" style="text-align: left">
            ...
            <div class="row mg" style="padding-top:20px;">
                <div class="col-md-1 col-sm-2">
                    <label>Report</label>
                </div>
                 <div class="col-md-3 col-sm-2">
                    <asp:DropDownList ID="ddl_reportName" runat="server" CssClass="txtBox" >
