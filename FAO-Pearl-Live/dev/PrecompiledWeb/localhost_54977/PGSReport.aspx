<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="PGSReport, App_Web_ju5zdh34" viewStateEncryptionMode="Always" %>
    ...
    <div class="container-fluid">      
        <div class="form" style="text-align: left">
            ...
            <div class="row mg">
                ...
                <div class="col-md-2 col-sm-2">
                    <%--<label>Vendor Code / Vendor Name</label>--%>
                </div>
                <div class="col-md-3 col-sm-3">
                    <%--<input type="text" id="txtVendorCode" class="txtBox" />--%>
                </div>
            ...
            <div class="row mg">
                <div class="col-md-2 col-sm-2">
                    <label id="lblFrom">Creation From Date</label>
                </div>
                <div class="col-md-3 col-sm-3">
                    <asp:TextBox runat="server" ID="txtd1" placeholder="Creation From Date" CssClass="txtBox"
                    ClientIDMode="Static"></asp:TextBox>
                    <asp:CalendarExtender ID="CalendarExtender1" runat="server" Format="yyyy-MM-dd" TargetControlID="txtd1">
                    </asp:CalendarExtender>
                </div>
                <div class="col-md-2 col-sm-2">
                    <label id="lblTo">Creation To date</label>
                </div>
                <div class="col-md-3 col-sm-3">
                    <asp:TextBox runat="server" placeholder="Creation To date" ID="txtd2" ClientIDMode="Static" CssClass="txtBox"></asp:TextBox>
                    <asp:CalendarExtender ID="CalendarExtender2" runat="server" Format="yyyy-MM-dd" TargetControlID="txtd2">
                    </asp:CalendarExtender>
                </div>
            </div>
            <br />
            <div id="dvInvoice" class="row mg">
                <div class="col-md-2 col-sm-2">
                    <label>Invoice From Date</label>
                </div>
                <div class="col-md-3 col-sm-3">
                    <asp:TextBox runat="server" ID="txtInvoiceFrom" placeholder="Creation From Date" CssClass="txtBox"
                    ClientIDMode="Static"></asp:TextBox>
                    <asp:CalendarExtender ID="CalendarExtender3" runat="server" Format="yyyy-MM-dd" TargetControlID="txtInvoiceFrom">
                    </asp:CalendarExtender>
                </div>
                <div class="col-md-2 col-sm-2">
                ...
                <div class="col-md-3 col-sm-3">
                    <asp:TextBox runat="server" placeholder="Creation To date" ID="txtInvoiceTo" ClientIDMode="Static" CssClass="txtBox"></asp:TextBox>
                    <asp:CalendarExtender ID="CalendarExtender4" runat="server" Format="yyyy-MM-dd" TargetControlID="txtInvoiceTo">
                    </asp:CalendarExtender>
                </div>
            </div>
            <br />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#ddlReportName").change(function () {
                ...
                if (reportid == "2136") {
                    $("#lblFrom").html("Payment From Date");
                    $("#lblTo").html("Payment To Date");
                    $("#dvInvoice").show();
                }
                else {
                    $("#lblFrom").html("").html("Creation From Date");
                    $("#lblTo").html("").html("Creation To date");
                    $("#dvInvoice").hide();
                }
            });
        ...
        function BindReportName() {
            ...
            $.ajax({
                type: "POST",
                url: "PGSReport.aspx/GetReportName",
        ...
        function GetReport() {
            ...
            var t1 = $("#txtd1").val();
            var t2 = $("#txtd2").val();
            var InvFrom = $("#txtInvoiceFrom").val();
            var InvTo = $("#txtInvoiceTo").val();
            var VendorCode = $.trim($("#txtVendorCode").val());
            $("#kgrdtl").html("");
            var str = '{"sdate": "' + t1 + '", "edate": "' + t2 + '","InvFrom": "' + InvFrom + '", "InvTo": "' + InvTo + '", "Reportid": "' + reportid + '"}';
            $.ajax({
                type: "POST",
                url: "PGSReport.aspx/GetData",
                data: str,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: BindReport,
