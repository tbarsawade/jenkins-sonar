<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="UserAttendanceReport, App_Web_o3dtvhns" enableeventvalidation="false" viewStateEncryptionMode="Always" %>
              ...
              <td align="left" class="style2">
                  <table   >
                      <tr>
                        ...
                        <legend style=" color:Black; text-align:left;font-weight:bold; "><asp:CheckBox ID="CheckBox1"  OnCheckedChanged="checkuncheck" AutoPostBack="true"  runat="server" />User/Student Name-Card CSN No.</legend>
