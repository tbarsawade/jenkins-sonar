<%@ page title="" language="VB" masterpagefile="~/usrFullScreenBPM.master" autoeventwireup="false" inherits="InvoiceApprovalPendency, App_Web_s1ukpvof" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetReport() {
            ...
            $("#kgrid").html('');
            var str = '{"sdate": "' + t1 + '", "edate": "' + t2 + '", "CreatedBy": "' + CreatedBy + '", "Department": "' + Department + '", "Status": "' + Status + '", "Entity": "' + Entity + '", "Vendor": "' + Vendor + '"}';
            $.ajax({
                type: "POST",
                url: "InvoiceApprovalPendency.aspx/GetData",
                data: str,
    ...
    <div class="container-fluid">
        <div class="form" style="text-align: left">
            <div class="doc_header">
                Invoice Approval Pendency Report
            </div>
            <br />
            <div class="row mg">
