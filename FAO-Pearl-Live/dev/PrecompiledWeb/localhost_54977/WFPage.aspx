<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="WFPage, App_Web_0xvfyc51" viewStateEncryptionMode="Always" %>
    ...
    <tr>
     <td colspan ="2" style="text-align: left;padding:0px;"  valign="top">
       <asp:GridView ID="gvData" runat="server" 
             CellPadding="4" DataKeyNames="DocID" Width="100%" 
               AllowSorting="True" OnPageIndexChanging="gridView_PageIndexChanging" OnSorting="gridView_Sorting" 
             PageSize="20" BackColor="White" BorderColor="#3366CC" BorderStyle="None" 
             BorderWidth="1px" AllowPaging="True">
                    ...
                    <HeaderStyle Font-Bold="True" ForeColor="#CCCCFF" 
                        CssClass="GridHeader" BackColor="#003399" />
                    <Columns>
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                               <asp:ImageButton ID="btnView" ImageUrl="~/images/view.png"  runat="server" Height="16px" Width="16px" OnClick="ShowHit"  ToolTip="View / Download File"/>
                                 &nbsp;
                                <asp:ImageButton ID="BTNDETAIL" runat="server" ImageUrl="~/images/show.png" Height="16px" Width="16px" OnClick="ShowDetailAction" ToolTip ="View Detail" AlternateText="View Detail" />
                                 &nbsp;
                                <%--<asp:ImageButton ID="BTNAPR" runat="server"    ImageUrl="~/images/av.png" Height="16px" Width="16px" OnClick="ShowApprove" ToolTip ="Approve Document" AlternateText="Approve Document" />
                                 &nbsp;
                                 <asp:ImageButton ID="BTNREJ"   runat="server" ImageUrl="~/images/notav.png" Height="16px" Width="16px" OnClick="ShowReject" ToolTip ="Reject Document" AlternateText="Reject Document" />
                            &nbsp;--%>
                            </ItemTemplate>
 ...
 <asp:Panel ID="pnlFields" Width="100%" runat="server">
            ...
            <%-- <div style="width:100%;text-align:right">
                    <asp:Button ID="btnApprove" runat="server" Text="Approve" 
                            ...
                            Font-Size="X-Small" Width="100px" OnClick="editBtnApprove" />
                    </div>
   </ContentTemplate> 
   </asp:UpdatePanel> 
</td>
 ...
 <asp:Panel ID="pnlFieldsRej" Width="100%" runat="server">
          ...
          <div style="width:100%;text-align:right">
                   <%-- <asp:Button ID="btnReject" runat="server" CssClass="btnNew" Font-Bold="True" 
                        Font-Size="X-Small" OnClick="editBtnReject" Text="Reject" 
                        Width="100px" />
           </div> 
   </ContentTemplate> 
   </asp:UpdatePanel> 
