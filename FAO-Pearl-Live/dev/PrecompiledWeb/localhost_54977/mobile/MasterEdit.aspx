<%@ page language="VB" autoeventwireup="false" inherits="mobile_MasterEdit, App_Web_towehstj" viewStateEncryptionMode="Always" %>
...
<body>
    ...
    <asp:Panel ID="pnlPopupchild" runat="server" Width="100%" Height="420px" Style="display: none"
        BackColor="aqua">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Panel ID="Panel1" runat="server">
                                    <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label></asp:Panel>
                        ...
                        <asp:UpdatePanel ID="updpnlchild" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Panel ID="Pnllable" runat="server">
                                    <asp:Label ID="Label4" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label></asp:Panel>
