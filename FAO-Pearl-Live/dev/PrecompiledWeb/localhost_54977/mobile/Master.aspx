<%@ page language="VB" autoeventwireup="false" inherits="mobile_Master, App_Web_tkx4sz31" viewStateEncryptionMode="Always" %>
                ...
                <td style="text-align: left" valign="top" width="100%">
                    <div style="overflow: auto; width: 100%">
                        <asp:GridView ID="gvData" runat="server" CssClass="GridView" CellPadding="2" DataKeyNames="tid"
                             AllowSorting="True" AllowPaging="True" PageSize="15" Width="100%">
