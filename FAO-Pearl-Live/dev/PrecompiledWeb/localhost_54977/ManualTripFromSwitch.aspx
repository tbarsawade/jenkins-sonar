<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="TripReport, App_Web_dqvq3srr" enableeventvalidation="false" viewStateEncryptionMode="Always" %>
        ...
        <asp:UpdatePanel ID="updPnlSearch" runat="server">
                ...
                <table cellpadding="5px" cellspacing="5px" style="width: 100%; border: solid; color: blue;
                    ...
                    <tr>
                        <td colspan="3" style="text-align: center">
                            <asp:Label ID="lblHeader" runat="server" Text="Manual Trip Craetion From Switch" Style="font-weight: bold;
          ...
          <asp:Label ID="lblmsg" runat="server" Font-Bold="true" ForeColor="Red"  ></asp:Label>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btsSearch" runat="server" Text="Create Trip" CssClass="btnNew" />
                            &nbsp;
