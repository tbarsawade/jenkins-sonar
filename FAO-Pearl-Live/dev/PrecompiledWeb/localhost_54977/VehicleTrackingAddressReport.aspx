<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="ExternalPowerReport, App_Web_15ulzn3z" enableeventvalidation="false" viewStateEncryptionMode="Always" %>
...
<asp:ImageButton ID="btnExportPDF" ToolTip="Export PDF"  runat="server" Width="18px" ImageAlign="Right"  Height="18px" Visible="false"  ImageUrl="~/images/export.png"/>&nbsp;&nbsp;
...
<div class="gradientBoxesWithOuterShadows" id="div1" style="margin-top:10px">
              ...
              <td align="left" class="style2">
                  <table   >
                      <tr>
                          ...
                          <td >
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;From Date&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtsdate" runat="server"></asp:TextBox>
                                 <asp:CalendarExtender  ID="calendersdate"   TargetControlID="txtsdate" Format="yyyy-MM-dd 00':'00'"    runat="server" /> <br/><br />
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="txtedate"  runat="server" AutoCompleteType="Search" ></asp:TextBox>
                                 <asp:CalendarExtender  ID="CalendarExtender1" TargetControlID="txtedate" Format="yyyy-MM-dd 23':'59'" runat="server" /> <br /><br />
                                 </td>
                              </tr>
                        ...
                        <legend style=" color:Black; text-align:left;font-weight:bold; "><asp:CheckBox ID="CheckBox1"  OnCheckedChanged="checkuncheck" AutoPostBack="true"  runat="server" /><asp:Label ID="lblveh" runat="server" Text=""></asp:Label></legend>
  ...
  <asp:Panel  runat="server" ID="pngv"> 
                      <asp:GridView ID="GVReport" runat="server" AllowPaging="False" RowStyle-HorizontalAlign="Left"  
                          ...
                          <RowStyle BackColor="White" BorderColor="Green" BorderWidth="1px" HorizontalAlign="Left"  
                      ...
                      <asp:GridView ID="GVReport1" runat="server" AllowPaging="true" 
                          ...
                          <RowStyle BackColor="#F7F6F3" ForeColor="#333333" HorizontalAlign="Center" 
                            ...
                            <ItemTemplate>
                                   <a class="detail" style="text-decoration:none;"  href="#" onclick="OpenWindow('http://<%#  HttpContext.Current.Request.Url.Authority + HttpContext.Current.Request.ApplicationPath  %>/ShowmapGps.aspx?tid=<%#DataBinder.Eval(Container.DataItem, "tid")%>&type=<%#DataBinder.Eval(Container.DataItem, "TripType")%>')"   >
