<%@ page title="" language="VB" masterpagefile="~/USR.master" autoeventwireup="false" inherits="VPISRep_Ven, App_Web_sifhu5tb" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetVtype() {
            $.ajax({
                type: "POST",
                url: "VPISRep_Ven.aspx/GetPGtype",
        ...
        function GetReport() {
            ...
            $.ajax({
                type: "POST",
                url: "VPISRep_Ven.aspx/GetData",
                data: str,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: BindReport,
                error: function (err) { alert('Some Error Occurred'); },
    ...
    <div style="width: 100%; height: 47px; padding-top: 15px; padding-left: 10px; font: bold 17px 'verdana';
        ...
        Appproval Status of Invoices in PEARL
    </div>
    <br />
    <table style="width: 100%; border: 1; padding: 10px;">
        ...
        <tr>
            <td style="width: 300px">
                <select id="ddlPurchaseGrp" data-placeholder="Invoice Status"  style="width: 200px;">
