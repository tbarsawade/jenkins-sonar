...
Partial Class logbookreport
    ...
    End Sub
    <WebMethod>
    Public Shared Function GetJSON(d1 As String, d2 As String) As pichartColNight
        Dim ret As New pichartColNight()
        Dim ds As New DataSet()
        Dim Query As String = ""
        ...
        Try
            ...
            '    'Next
            '    Dim obj As pichartNight
            '    Dim o1 As New List(Of pichartNight)()
            '    Dim o2 As New List(Of pichartNight)()
            '    Dim o3 As New List(Of pichartNight)()
            '    For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
            '        obj = New pichartNight()
        ...
        Return ret
    End Function
    'Public Shared Function GetLogBook1(d1 As String, d2 As String, uid As Integer, urole As String) As DataSet
    '    Dim ds As New DataSet()
    '    Dim ConStr As String = ConfigurationManager.ConnectionStrings("conStr").ConnectionString
    '    Using con As New SqlConnection(ConStr)
    '        Using da As New SqlDataAdapter("getIndusnightLogBook", con)
...
End Class
Public Class pichartNight
    Public category As String
    Public value As String
    'Public color As String
End Class
Public Class pichartColNight
