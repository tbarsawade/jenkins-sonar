...
Partial Class MISSendGreeting
    ...
    Private Sub SendMailGreetings(mailto As String, uname As String)
        ...
        mBody = mBody & "<img src=""http://www.myndsaas.com/greetings/diwali greeting(int).jpg"" alt=""Happy Diwali"" /><br/>"
        mBody = mBody & "<a href=""http://www.myndsaas.com/greetings/MISDiwali.html"">Click Here To View Greeting</a>"
        mBody = mBody & "</div>"
