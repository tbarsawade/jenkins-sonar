...
Partial Class InvoiceApprovalPendency
    ...
    Public Shared Function GetData(sdate As String, edate As String, CreatedBy As String, Department As String, Status As String, Entity As String, Vendor As String) As DGrid
        ...
        Try
            ...
            da.SelectCommand.CommandText = "InvoiceApprovalPendencyReport_PTM"
            ...
            '    da.SelectCommand.CommandText = "select qryfield[cmd] from mmm_mst_report with(nolock) where reportid=2119"
            'Else
            '    da.SelectCommand.CommandText = "select qryfieldrole[cmd] from mmm_mst_report with(nolock) where reportid=2119"
            'End If
            'da.Fill(ds, "qry")
