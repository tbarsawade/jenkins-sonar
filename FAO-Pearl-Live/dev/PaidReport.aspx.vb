    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Try
                ...
                '' 
                da.SelectCommand.CommandText = "select Reportid,ReportName from mmm_mst_report where eid=" & Session("EID") & " and reportname like 'Cops paid%' order by reportid "
                da.Fill(ds, "data")
