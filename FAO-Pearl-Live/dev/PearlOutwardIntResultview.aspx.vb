...
Partial Class PearlOutwardIntResultview
    ...
    Public Shared Function GetData(sdate As String, edate As String) As DGrid
        ...
        Try
            ...
            Dim qry As String = ""
            da.SelectCommand.CommandText = "select CID,convert(varchar, EntryDate, 113) EntryDate,ActionCode [Integration Type], Result,Remarks [Response Rcvd], XMLFileName [Request Sent] From Staging_Outwardintegration_Result where cid= '" & HttpContext.Current.Session("EID") & "' and cast(entrydate as date) >= cast('" + sdate + "' as date) and cast(entrydate as date) <= cast('" + edate + "' as date) order by entrydate"
