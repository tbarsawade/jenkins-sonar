...
Partial Class VPInvStatusReport
    ...
    Public Shared Function GetPGtype() As String
        ...
        Dim Qry As String = "select tid,fld1 from mmm_mst_master with(nolock) where eid=" & HttpContext.Current.Session("EID").ToString() & " and documenttype='Purchase Group'"
    ...
    Public Shared Function GetData(sdate As String, tdate As String, PoNum As String, Vname As String, PrGrp As String) As DGrid
        ...
        da.SelectCommand.CommandText = "select qryfield[cmd] from mmm_mst_report with(nolock) where reportid=805"
        da.Fill(ds, "qry")
        ...
        If PrGrp = "null" Then
            qry = qry.Replace("and fld178 in (@PrGrp)", "")
        End If

        qry = qry.Replace("@PrGrp", PrGrp)
