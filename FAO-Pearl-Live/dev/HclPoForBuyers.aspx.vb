...
Partial Class HclPoForBuyers
    ...
    Public Shared Function GetPGtype() As String
        ...
        Dim Qry As String = "select tid,fld1 from mmm_mst_master with(nolock) where eid=46 and documenttype='Purchase Group'"
    ...
    Public Shared Function GetData(sdate As String, tdate As String, PoNum As String, Vname As String, PrGrp As String) As DGrid
        ...
        Dim ds As New DataSet()
        Dim qry As String = ""
        da.SelectCommand.CommandText = "select qryfield[cmd] from mmm_mst_report where reportid=801"
        da.Fill(ds, "qry")
