...
Partial Class VIAgeingPTM
    ...
    Public Shared Function GetData(sdate As String, edate As String, CreatedBy As String, Department As String, Status As String, Entity As String, Vendor As String) As DGrid
        ...
        Try
            ...
            da.SelectCommand.CommandText = "VendorInvoiceAgeingReport_PTM"
            ...
            '    da.SelectCommand.CommandText = "select qryfield[cmd] from mmm_mst_report with(nolock) where reportid=2116"
            'Else
            '    da.SelectCommand.CommandText = "select qryfieldrole[cmd] from mmm_mst_report with(nolock) where reportid=2116"
            'End If
            'da.Fill(ds, "qry")
