<%@ Page Title="" Language="VB" MasterPageFile="~/usrFullScreenBPM.master" AutoEventWireup="false" CodeFile="PayU_ApValidation_Summary_Report.aspx.vb" Inherits="PayU_ApValidation_Summary_Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="form" style="text-align: left">
            ...
            <div class="row mg">
                ...
                <div class="col-md-3 col-sm-3">
                    <select id="ddlCompCode" class="txtBox">
                ...
                <div class="col-md-3 col-sm-3">
                    <select id="ddlStatus" class="txtBox">
                        <option value="Validation">Ap Validation</option>
                        <option value="Validation">Approval</option>
                        <option value="Validation">Update of Payment Details</option>
                    </select>
                </div>
            ...
            <div class="row mg">
                ...
                <div class="col-md-3 col-sm-3">
                    <asp:TextBox runat="server" ID="txtd1" placeholder="Invoice From Date" ReadOnly="true" CssClass="txtBox"
                ...
                <div class="col-md-3 col-sm-3">
                    <asp:TextBox runat="server" placeholder="Invoice To date" ReadOnly="true" ID="txtd2" ClientIDMode="Static" CssClass="txtBox"></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function BindCompanyCode() {
            var ddlCompCode = $("#ddlCompCode");
            var t = '{ documentType: ""}';
            $.ajax({
                type: "POST",
                url: "PayU_ApValidation_Summary_Report.aspx/BindCompanyCode",
                contentType: "application/json; charset=utf-8",
                data: t,
                dataType: "json",
                success: function (response) {
                    var strData = JSON.parse(response.d.Data);
                    ddlCompCode.empty().append($('<option></option>').val("").html("-- Select --"));
                    if (strData.length > 0) {
                        $.each(strData, function () {
                            ddlCompCode.append($('<option></option>').val(this.CompanyCode).html(this.CompanyCode));
                        });
        ...
        function GetReport() {
            ...
            $("#kgrdtl").html("");
            var str = '{"sdate": "' + t1 + '", "edate": "' + t2 + '", "CompCode": "' + compCode + '", "Status": "' + status + '"}';
            $.ajax({
                type: "POST",
                url: "PayU_ApValidation_Summary_Report.aspx/GetData",
                data: str,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: BindReport,
