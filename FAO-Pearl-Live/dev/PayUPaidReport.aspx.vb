...
Partial Class PayUPaidReport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Try
                ...
                '' 
                da.SelectCommand.CommandText = "select Reportid,ReportName from mmm_mst_report where eid=" & Session("EID") & " and reportid in (1711,1710) order by reportid "
                da.Fill(ds, "data")
                ...
                da.SelectCommand.CommandText = "select distinct fld2 from mmm_mst_master where eid=" & Session("EID") & " and documenttype='month Master'"
                ds.Clear()
                da.Fill(ds, "data")
                ddlyear.DataSource = ds
                ddlyear.DataTextField = "fld2"
                ddlyear.DataValueField = "fld2"
                ddlyear.DataBind()
    ...
    Protected Shared Function GenearateQuery(Year As String) As DGrid
        Dim ret As String = ""
   ...
   <Script.Services.ScriptMethod()>
    Public Shared Function GetData(Year As String) As DGrid
        Dim d As New DGrid()
        Try
            'If HttpContext.Current.Session("DCType") <> "0" Then
            d = GenearateQuery(Year)
            'End If
        Catch ex As Exception
            ex.ToString()
        End Try
