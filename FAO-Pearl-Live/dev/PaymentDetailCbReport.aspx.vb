...
Partial Class PaymentDetailCbReport
    ...
    Public Shared Function GetData(sdate As String, edate As String) As DGrid
        ...
        Try
            ...
            If System.Web.HttpContext.Current.Session("USERROLE") = "SU" Then
                da.SelectCommand.CommandText = "select qryfield[cmd] from mmm_mst_report with(nolock) where reportid=2123"
            Else
                da.SelectCommand.CommandText = "select qryfieldrole[cmd] from mmm_mst_report with(nolock) where reportid=2123"
            End If
            da.Fill(ds, "qry")
