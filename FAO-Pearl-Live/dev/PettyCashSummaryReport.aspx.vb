...
Partial Class PettyCashSummaryReport
    ...
    Public Shared Function GetData(sdate As String, tdate As String) As DGrid
        ...
        Try
            ...
            If HttpContext.Current.Session("USERROLE").ToString.ToUpper = "SU" Or HttpContext.Current.Session("USERROLE").ToString.ToUpper = "CADMIN" Then
                da.SelectCommand.CommandText = "select qryfield from mmm_mst_report where eid=" & eid & "  and Reportid=1712 "
            Else
                da.SelectCommand.CommandText = "select qryfieldrole from mmm_mst_report where eid=" & eid & "  and Reportid=1712 "
            End If
