    ...
    Public Shared Function GetData(sdate As String, tdate As String) As DGrid
        ...
        Try
            If HttpContext.Current.Session("USERROLE").ToString.ToUpper = "SU" Or HttpContext.Current.Session("USERROLE").ToString.ToUpper = "CADMIN" Then
                da.SelectCommand.CommandText = "select qryfield from mmm_mst_report where eid=" & eid & "  and reportname='PR To PO Status Report' "
            Else
                da.SelectCommand.CommandText = "select qryfieldrole from mmm_mst_report where eid=" & eid & "  and reportname='PR To PO Status Report' "
            End If
            ...
            Else
                ...
                If Dept1 = "" Then
                    Exit Function
                End If
                str = Replace(str, "@role", " dpr.fld2 in (" & Dept1 & ")")
            End If
