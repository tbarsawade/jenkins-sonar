...
Partial Class ControlReport
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Dim inst As Integer = Convert.ToInt32(Request.QueryString("flag"))
            Session("ReportFlag") = inst
            If Session("ReportFlag") = "0" Then
                lblReport.Text = "Control Report"
            ElseIf Session("ReportFlag") = "1" Then
                lblReport.Text = "Consolidated Control Report"
            End If
        End If
    End Sub
    <WebMethod()> _
    Public Shared Function GetData(sdate As String, edate As String, Bunit As String) As DGrid
        ...
        Try
            ...
            Dim qry As String = ""
            If HttpContext.Current.Session("ReportFlag") = "0" Then
                da.SelectCommand.CommandText = "select qryfield[cmd] from mmm_mst_report with(nolock) where reportid=964"
            ElseIf HttpContext.Current.Session("ReportFlag") = "1" Then
                da.SelectCommand.CommandText = "select qryfield[cmd] from mmm_mst_report with(nolock) where reportid=965"
            End If
            'If System.Web.HttpContext.Current.Session("USERROLE") = "HRSPOC" Then
            '    da.SelectCommand.CommandText = "select qryfield[cmd] from mmm_mst_report with(nolock) where reportid=964"
            'Else
            '    da.SelectCommand.CommandText = "select qryfieldrole[cmd] from mmm_mst_report with(nolock) where reportid=964"
            'End If
            da.Fill(ds, "qry")
    ...
    Public Shared Function GetExport(sdate As String, edate As String, Bunit As String) As String
        ...
        Try
            ...
            da.SelectCommand.CommandTimeout = 900
            da.Fill(dt)
            Dim fname As String = "ControlReport.CSV"
